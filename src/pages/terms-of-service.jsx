            ...
            <div className="col-xl-12">
              <div className="tp-about-wrapper">
                ...
                <div className="tp-about-content mb-40">
                  ...
                  <p className="mb-30">
                    에끌라린(이하 "회사")이 제공하는 인터넷 관련 서비스(이하 '서비스')를 이용함에
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <p>
                    ...
                    관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"이란 회사가 악세서리 등을 이용자에게 제공하기 위하여 컴퓨터 등
                      정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을
                      말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                    </li>
                    <li>
                      ② "이용자"란 "사이버몰"에 접속하여 이 약관에 따라 "사이버몰"이 제공하는
                      서비스를 받는 회원 및 비회원을 말합니다.
                    </li>
                    <li>
                      ③ "회원"이란 "사이버몰"에 개인정보를 제공하여 회원등록을 한 자로서,
                      "사이버몰"의 정보를 지속적으로 제공받으며, "사이버몰"이 제공하는 서비스를
                      계속적으로 이용할 수 있는 자를 말합니다.
                    </li>
                    <li>
                      ④ "비회원"이란 회원에 가입하지 않고 "사이버몰"이 제공하는 서비스를 이용하는
                      자를 말합니다.
                    </li>
                  </ul>
                </div>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    ...
                    <li>
                      ② "사이버몰"은 이 약관을 개정하는 경우에 적용일자 및 개정사유를 명시하여
                      현행약관과 함께 사이버몰의 초기화면에 그 적용일자 7일 이전부터 적용일자
                      전일까지 공지합니다.
                    </li>
                  </ul>
                </div>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    ...
                    <li>
                      ② "사이버몰"은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의 경우에는
                      장차 체결되는 계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다.
                      이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① 이용자는 "사이버몰"이 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에
                      동의한다는 의사표시를 함으로서 회원가입을 신청합니다.
                    </li>
                    <li>
                      ② "사이버몰"은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에
                      ...
                      <ul className="tp-about-list ml-20 mt-10">
                        ...
                        <li>
                          - 기타 회원으로 등록하는 것이 "사이버몰"의 기술상 현저히 지장이 있다고
                          판단되는 경우
                        </li>
                      </ul>
                    </li>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <p className="mb-15">
                    "사이버몰" 이용자는 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며,
                    "사이버몰"은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게
                    제공하여야 합니다.
                  </p>
                  <ul className="tp-about-list">
                    <li>① 재화 등의 검색 및 선택</li>
                    ...
                    <li>
                      ⑤ 재화등의 구매신청 및 이에 관한 확인 또는 "사이버몰"의 확인에 대한 동의
                    </li>
                    <li>⑥ 결제방법의 선택</li>
                  </ul>
                </div>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"은 제6조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지
                      않을 수 있습니다.
                      <ul className="tp-about-list ml-20 mt-10">
                        ...
                        <li>
                          - 기타 구매신청에 승낙하는 것이 "사이버몰" 기술상 현저히 지장이 있다고
                          판단하는 경우
                        </li>
                      </ul>
                    </li>
                    <li>
                      ② "사이버몰"의 승낙이 제12조제1항의 수신확인통지형태로 이용자에게 도달한
                      시점에 계약이 성립한 것으로 봅니다.
                    </li>
                  </ul>
                </div>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <p className="mb-15">
                    "사이버몰"에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법 중
                    가용한 방법으로 할 수 있습니다. 단, "사이버몰"은 이용자의 지급방법에 대하여 재화
                  ...
                  <ul className="tp-about-list">
                    ...
                    <li>⑦ "사이버몰"과 계약을 맺었거나 "사이버몰"이 인정한 상품권에 의한 결제</li>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상,
                      이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장
                      등 기타의 필요한 조치를 취합니다.
                    </li>
                    <li>
                      ② "사이버몰"은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자,
                      수단별 배송기간 등을 명시합니다.
                    </li>
                    <li>
                      ③ 배송비 정책
                    ...
                    <li>
                      ④ 만약 "사이버몰"이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를
                      배상하여야 합니다.
                    </li>
                  </ul>
                </div>
                    ...
                    <ul className="tp-about-list mb-20">
                      ...
                      <li>
                        ...
                        <ul className="tp-about-list ml-20 mt-10">
                          ...
                          <li>
                            - 개별 주문 제작되는 재화 등 청약철회시 "사이버몰"에게 회복할 수 없는
                            피해가 예상되는 경우
                          </li>
                        </ul>
                      </li>
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서
                      최소한의 개인정보를 수집합니다.
                    </li>
                    <li>
                      ② "사이버몰"은 회원가입시 구매계약이행에 필요한 정보를 미리 수집하지 않습니다.
                    </li>
                    <li>
                      ③ "사이버몰"은 이용자의 개인정보를 수집·이용하는 때에는 당해 이용자에게 그
                      목적을 고지하고 동의를 받습니다.
                    </li>
                    <li>
                      ④ "사이버몰"은 수집된 개인정보를 목적외의 용도로 이용할 수 없으며, 새로운
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"은 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할
                      수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.
                    </li>
                    <li>
                      ② "사이버몰"은 이용자의 귀책사유로 인한 서비스 이용의 장애에 대하여는 책임을
                      지지 않습니다.
                    </li>
                    <li>
                      ③ "사이버몰"은 이용자가 서비스를 이용하여 기대하는 손익이나 서비스를 통하여
                ...
                <div className="tp-about-content mb-30">
                  ...
                  <ul className="tp-about-list">
                    <li>
                      ① "사이버몰"과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 민사소송법상의
                      관할법원에 제기합니다.
                    </li>
                    <li>
                      ② "사이버몰"과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                    </li>
                  </ul>
                </div>
