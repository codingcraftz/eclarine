...
// /form 라이브 주문서 전용 입금계좌 — /shop·/pay 의 ACCOUNT 와 별개다
export const FORM_ACCOUNT = {
  bank: 'KB국민',
  number: '409102-01-206222',
  holder: '정*은',
};

export const KAKAO_CHANNEL = 'http://pf.kakao.com/_qxcWrn';

// 토스 앱 송금창 딥링크. 계좌번호는 하이픈 없이 넘긴다.
export const tossSendUrl = ({ bank, number }, origin = '에끌라린주문서') =>
  `supertoss://send?bank=${encodeURIComponent(bank)}&accountNo=${number.replace(
    /\D/g,
    ''
