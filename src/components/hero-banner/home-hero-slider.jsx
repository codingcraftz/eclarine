...
const sliderData = [
  {
    id: 1,
    pre_title: { text: "시작가", price: "89,000원" },
    title: "925 실버 프리미엄 콜렉션",
    subtitle: {
      text_1: "신규회원 특가 ",
      percent: 30,
      text_2: "할인 진행중",
  ...
  {
    id: 2,
    pre_title: { text: "시작가", price: "25,000원" },
    title: "써지컬 스틸 알레르기 안전 악세서리",
    subtitle: {
      text_1: "베스트셀러 ",
      percent: 20,
      text_2: "할인 혜택",
  ...
  {
    id: 3,
    pre_title: { text: "시작가", price: "450,000원" },
    title: "14K 골드 럭셔리 콜렉션",
    subtitle: {
      text_1: "프리미엄 골드 ",
      percent: 15,
      text_2: "특별 할인",
...
function Shape({ img, num }) {
  return <Image className={`tp-slider-shape-${num}`} src={img} alt="slider-shape" priority />;
}
