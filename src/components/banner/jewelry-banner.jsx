...
// slider data (한글로 변경)
const slider_data = [
  { subtitle: "에끌라린", title: "반짝이는 순간", img: slider_img_1 },
  { subtitle: "에끌라린", title: "창의적 디자인", img: slider_img_2 },
  { subtitle: "에끌라린", title: "골드 플레이팅", img: slider_img_3 },
  { subtitle: "에끌라린", title: "독특한 형태", img: slider_img_4 },
];

// slider nav data (한글로 변경)
