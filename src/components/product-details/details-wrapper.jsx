  ...
  return (
    <div className="tp-product-details-wrapper">
      ...
      <div className="tp-product-details-price-wrapper mb-20">
        {discount > 0 ? (
          <>
            <span className="tp-product-details-price old-price">₩{price.toLocaleString()}</span>
          ...
          <span className="tp-product-details-price new-price">₩{price.toLocaleString()}</span>
        )}
      </div>
      ...
      <div className="tp-product-details-action-wrapper">
        <h3 className="tp-product-details-action-title">수량</h3>
        ...
        <Link href="/cart" onClick={() => dispatch(handleModalClose())}>
          <button className="tp-product-details-buy-now-btn w-100">바로 구매</button>
        </Link>
      </div>
