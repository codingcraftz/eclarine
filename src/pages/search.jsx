    ...
    if (product_items.length === 0) {
      content = (
        <div className="text-center pt-80 pb-80">
          <h3>
            Sorry, nothing matched <span style={{ color: "#0989FF" }}>{searchText}</span> search
            terms
          </h3>
        </div>
      );
                        ...
                        <div className="col-xl-6">
                          <div className="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
                            <div className="tp-shop-top-select">
                              <NiceSelect
                                options={[
                                  { value: "Short By Price", text: "가격순 정렬" },
                                  { value: "Price low to high", text: "가격 낮은순" },
                                  { value: "Price high to low", text: "가격 높은순" },
                                ]}
                                defaultCurrent={0}
